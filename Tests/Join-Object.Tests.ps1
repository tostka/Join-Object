...
Describe 'Module Information' -Tags 'Command'{
    Context 'Manifest Testing' {
        ...
        It 'Valid Manifest GUID' {
            $Script:ManifestHash.Guid | Should -Be "132033e6-3f91-40c3-b669-038d4e95edee"
        }
        <#
        It 'No Format File' {
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUGm9wCVWWkDQrKWNkANu1rz2M
...
# CisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBTJn/oy
# H7XBzOm/cE83QL2UXDsZITANBgkqhkiG9w0BAQEFAASBgADvbev33BRt4KZe6J8n
# 3/ROsecX5w9rV0Hs842FlroK0hQ0h//iuqKT+1mWI1UXoTwlCFCqjRP2xnVsF/Q8
# Fxtc/52IE4ic/YMVv25w1bBnHZ64Nr+1DZcrKDJAtd2o0SGYsp/Lk44h3RjcFmA3
# /oIM+ZAObZXoGtLE61CRFM0S
